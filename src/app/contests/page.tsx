          ...
          <div className="lg:col-span-6 relative flex items-center justify-center select-none pointer-events-none">
            ...
            <div className="relative w-full max-w-[580px] flex items-center justify-center animate-float-slow">
              <img
                ...
                className="w-full h-auto object-contain max-h-[460px] sm:max-h-[520px] mix-blend-multiply dark:mix-blend-lighten filter contrast-[1.03] drop-shadow-[0_15px_25px_rgba(0,0,0,0.12)] dark:drop-shadow-[0_20px_35px_rgba(6,182,212,0.25)] transition duration-700 hover:scale-105"
                style={{
